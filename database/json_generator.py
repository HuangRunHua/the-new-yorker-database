...
class MagazineGenerator(object):
    ...
    def __parse_article(self, parsed_lines: list[str], filename: str):
        ...
        with open(self.__location__ + '/' + self.__folder + "/eposide/" + filename[:-3] + ".json", "w") as outfile:
...
if __name__ == "__main__":
    article_analyzer = MagazineGenerator(folder="2022-12-26")
    # article_analyzer = MagazineGenerator(folder="2022-12-19")
    # article_analyzer = MagazineGenerator(folder="2022-12-12")
    # article_analyzer = MagazineGenerator(folder="daily-articles")
    # article_analyzer = MagazineGenerator(folder="2022-12-04")
